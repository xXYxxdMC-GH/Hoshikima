...
public class FeatureConfigScreen extends AbstractConfigScreen {
    ...
    protected void initContent() {
        ...
        adder.add(ButtonWidget.builder(
                    ...
                    button -> this.client.setScreen(new ChainMineConfigScreen(this, this.pendingConfig))).build(), 1);
        adder.add(ButtonWidget.builder(
                    Text.translatable("config.hoshikima.category.other"), 
                    button -> this.client.setScreen(new OtherConfigScreen(this, this.pendingConfig))).build(), 1);
